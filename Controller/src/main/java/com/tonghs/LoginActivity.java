...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nUsername = getIntent().getStringExtra(EXTRA_EMAIL);
        nUsernameView = (EditText) findViewById(R.id.username);
        nUsernameView.setText(nUsername);
    ...
    public void attemptLogin() {
        ...
        nUsername = nUsernameView.getText().toString();
